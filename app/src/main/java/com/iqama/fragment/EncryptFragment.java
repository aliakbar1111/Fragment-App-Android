...
public class EncryptFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TextView tv_textView = view.findViewById(R.id.display_txt_massage);
        String message =  EncryptFragmentArgs.fromBundle(getArguments()).getMassage();


        tv_textView.setText(message);
    }
}